...
interface DirectMessagesProps {
    onSelectConversation?: (conv: { id: number; name: string; avatar: string }) => void;
}

export function DirectMessages({ onSelectConversation }: DirectMessagesProps) {
    ...
    const handleClick = (conv: Conversation) => {
        if (conv.isConnected && onSelectConversation) {
            onSelectConversation({ id: conv.id, name: conv.name, avatar: conv.avatar });
        }
    };
                    ...
                    <div
                        ...
                        className={
                            cn(
                                ...
                                conv.isConnected && "cursor-pointer hover:bg-secondary/50"
                            )
                        }
                    >
